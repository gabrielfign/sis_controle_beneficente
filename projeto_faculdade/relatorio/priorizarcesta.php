...
//ABRIR CONEXÃO COM O BANCO DE DADOS
	...
	*/
        ...
        $mpdf->WriteHTML('<br/><h1>Priorização de Cestas Básicas</h1><hr/>');
...
$conteudo.="    <tbody><tr>";
$conteudo.="      <th>Filhos(qtd)</th>";
$conteudo.="      <th>Nome</th>";
$conteudo.="      <th>Telefone</th>";
$conteudo.="    </tr>";
		
// cria a instrução SQL que vai selecionar os dados
$sql = ("select count(c.id_resp) Filhos, r.nome Nome, r.telefone Telefone,r.observacao Observação from responsavel as r inner join crianca as c on r.id_resp = c.id_resp group by c.id_resp order by count(c.id_resp) desc");
