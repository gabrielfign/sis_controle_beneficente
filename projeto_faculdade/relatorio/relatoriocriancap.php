...
//ABRIR CONEXÃO COM O BANCO DE DADOS
	...
	*/
        ...
        $mpdf->WriteHTML('<br/><h1>Crianças que não possuem doadores</h1><hr/>');
...
$sql = ("SELECT id_cri, nome FROM crianca WHERE id_doador IS NULL");
